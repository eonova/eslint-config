...
export async function formatters(
  ...
  if (options.markdown) {
    ...
    configs.push({
      ...
      name: 'eonova: formatter/markdown',
      rules: {
        [`format/${formater}`]: [
          'error',
          formater === 'prettier'
  ...
  if (options.astro) {
    ...
    configs.push({
      ...
      name: 'eonova: formatter/astro/disables',
      rules: {
