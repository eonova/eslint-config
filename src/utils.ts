...
const isCwdInScope = isPackageExists('@eonova/eslint-config')
 ...
 * @example
 * ```ts
 * import { renameRules } from '@eonova/eslint-config'
 *
 * export default [{
 *   rules: renameRules(
 *     {
 ...
 * @example
 * ```ts
 * import { renamePluginInConfigs } from '@eonova/eslint-config'
